  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-between mb-3">
        <h2 className="font-serif text-xl" style={{ color: "#cdb6ff" }}>
          Shadow Network
        </h2>
        <span className="text-[10px] font-mono uppercase tracking-widest text-white/40">
          Prime 11 · {chart.shadowNetwork.length} bonds · {chart.invisibleShadowBonds.length}{" "}
          invisible
        </span>
      </div>
      <p className="text-xs text-white/50 mb-3 italic">
        Bonds where r₁₁ matches. Invisible bonds reveal the +60% structure no traditional astrology
        can see.
      </p>
              ...
              {bonds.map((b, i) => (
                <span
                  ...
                  style={{
                    ...
                    border: invisibleKey.has(k(b.a, b.b))
                      ? "1px dashed #9d7bff66"
