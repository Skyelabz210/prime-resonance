    ...
    <div className="rounded border border-white/10 bg-black/30 px-3 py-2 backdrop-blur">
      <div className="flex items-center justify-between mb-1">
        <div className="flex items-center gap-2">
          <span className="text-lg" style={{ color: "#e6e8ff" }}>{PLANET_GLYPHS[planet.name] || "•"}</span>
      ...
      <div className="text-xs font-mono text-white/70 mb-1.5">{formatPosition(planet.longitudeArcsec)}</div>
